...
The accuracy of the testing dataset is ~48% which is a lot poorer than expected. Part of this may be due to the decision tree not being able to predict class D outcomes. 